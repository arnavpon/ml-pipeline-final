...
static const char qt_meta_stringdata_MR__GUI__App[] = {
    "MR::GUI::App\0\0startProgressBar()\0"
    "text,value,bounded\0"
    "displayProgressBar(QString,int,bool)\0"
    "doneProgressBar()\0"
};
...
const QMetaObjectExtraData MR::GUI::App::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MR::GUI::App::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MR__GUI__App,
      qt_meta_data_MR__GUI__App, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MR::GUI::App::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MR__GUI__App))
