...
static const char qt_meta_stringdata_MR__GUI__SpinBox[] = {
    "MR::GUI::SpinBox\0"
};
...
const QMetaObjectExtraData MR::GUI::SpinBox::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MR::GUI::SpinBox::staticMetaObject = {
    { &QSpinBox::staticMetaObject, qt_meta_stringdata_MR__GUI__SpinBox,
      qt_meta_data_MR__GUI__SpinBox, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MR::GUI::SpinBox::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MR__GUI__SpinBox))
